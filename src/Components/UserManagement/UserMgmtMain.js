        ...
        <div>
            ...
            <div class='tiles'>
                ...
                <div class='tiles-row2'>
                    <div class='Remove-user-tile' onClick={()=>navigate(`/UMRemoveUser`)}>
                        <div class="tile-contents">
                            {<FaUserAlt className='tiles-Ricons'/>}
                            <a href='UMRemoveUser' class='tiles-component-a'>Delete User</a>
                        </div>    
                    </div>
                    <div class='Supplier-site-tile' onClick={()=>navigate(`/UMViewSites`)}>
                        <div class="tile-contents">
                            {<FaBuilding className='tiles-Ricons'/>}
                            <a href='UMViewSites' class='tiles-component-a'>Supplier Site</a>
                        </div>    
                    </div>
                </div>
            </div> 

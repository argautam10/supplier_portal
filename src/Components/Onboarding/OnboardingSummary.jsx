...
const OnboardingSummary=({ prevStep, nextStep, handleChange, values })=>
{
    ...
    return (
        <div class='OnboardingMain-container'>
                    ...
                    <table className='OBDoc-DocUpload-Table'>
                        <tbody>
                            <tr>
                                ...
                                <td>Select File : </td>
                                <td class="DocTableCol3"> <input type='file' name='LicenseAgreementDoc' onChange={handleChange('LicenseAgreementDoc')} defaultValue={values.LicenseAgreementDoc}/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="DocTableCol1">Account Nmber</td>
                                <td></td>
            ...
            <br/>
            <button className='OB-next-btn' onClick={Continue}>Submit</button><br/><br/>
        </div>
    )   
};
